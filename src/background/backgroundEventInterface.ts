...
export interface BackgroundMessageOpenIngGameMenu extends MessageBase {
    type: "open-mod-menu";
}
...
BackgroundMessageOpenIngGameMenu | BackgroundMessageModDeveloper | BackgroundMessageModState;
